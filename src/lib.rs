...
#[derive(Debug)]
pub struct NanoPulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NanoPulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NanoPulse processing");
    
    let mut processor = NanoPulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NanoPulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NanoPulseProcessor::new(false);
